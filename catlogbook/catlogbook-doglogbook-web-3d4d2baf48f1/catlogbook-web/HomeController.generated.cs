...
namespace doglogbook_web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : doglogbook_web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Doglogbook.EntityFramework.Models.RegistrationOfInterest.RegistrationOfInterest model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(Doglogbook.EntityFramework.Models.RegistrationOfInterest.RegistrationOfInterest model)
        {
