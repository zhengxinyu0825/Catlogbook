...
namespace doglogbook_web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app, IKernel kernel)
        {
            ...
            app.CreatePerOwinContext(kernel.Resolve<DoglogbookDbContext>);
            app.CreatePerOwinContext(kernel.Resolve<MemberManager>);
            ...
            app.UseCookieAuthentication(options: new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<MemberManager, Member, int>(
